...
public interface ProcessTask extends Task {
  ...
  void setOperatonProcessBinding(String operatonProcessBinding);

  String getOperatonProcessVersion();

  void setOperatonProcessVersion(String operatonProcessVersion);

  String getOperatonProcessTenantId();

  void setOperatonProcessTenantId(String operatonProcessTenantId);
