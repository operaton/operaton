...
public class AsyncSequentialMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeProcess() {
    return "org/operaton/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTask() {
    return "org/operaton/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceTask.bpmn20.xml";
  }
