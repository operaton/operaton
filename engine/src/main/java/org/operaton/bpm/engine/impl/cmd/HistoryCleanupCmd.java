...
import org.operaton.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupContext;
import org.operaton.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
import org.operaton.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobDeclaration;
...
public class HistoryCleanupCmd implements Command<Job> {
  ...
  public Job execute(CommandContext context) {
    ...
    authorizationManager.checkOperatonAdmin();
