 ...
 *
 */
public @NullMarked class DelegateExpressionCaseVariableListener implements CaseVariableListener {
  ...
  public void notify(DelegateCaseVariableInstance variableInstance) throws Exception {
    ...
    if (delegate instanceof CaseVariableListener listenerInstance) {
      ...
      throw new ProcessEngineException("Delegate expression %s did not resolve to an implementation of %s".formatted(expression, CaseVariableListener.class));
    }
  }
