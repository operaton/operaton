  ...
  protected boolean doValidate(Object submittedValue, FormFieldValidatorContext validatorContext) {
    ...
    if(clazz != null) {
      ...
      if(validatorObject instanceof FormFieldValidator formFieldValidator) {
        ...
        throw new ProcessEngineException("Validator class '%s' is not an instance of ".formatted(clazz)+ FormFieldValidator.class.getName());
      }
    } else {
      ...
      if (validatorObject instanceof FormFieldValidator formFieldValidator) {
        ...
        throw new ProcessEngineException("Validator expression '%s' does not resolve to instance of ".formatted(delegateExpression)+ FormFieldValidator.class.getName());
      }
    }
