...
public interface TaskQuery extends Query<TaskQuery, Task> {
   ...
   * The syntax is that of SQL: for example usage: nameNotLike(%operaton%)
   * The query will match the names of tasks in a case-insensitive way.
   */
   ...
   * The syntax is that of SQL: for example usage: descriptionLike(%operaton%)
   * The query will match the descriptions of tasks in a case-insensitive way.
   */
   ...
   * The syntax is that of SQL: for example usage: processInstanceBusinessKeyLikeExpression("${ '%operaton%' }")
   */
   ...
   * The syntax is that of SQL: for example usage: taskDefinitionKeyLike("%operaton%").
   * The task definition key is the id of the userTask:
   * &lt;userTask id="xxx" .../&gt;
   **/
   ...
   * {@link Task#getFormKey()} and {@link Task#getOperatonFormRef()} will return a value (in
