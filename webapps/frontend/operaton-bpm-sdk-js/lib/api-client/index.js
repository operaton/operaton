 ...
 */
function OperatonClient(config) {
  if (!config) {
  ...
  this.HttpClient = config.HttpClient || OperatonClient.HttpClient;
 ...
 * @memberof CamSDK.client.OperatonClient
 * @name HttpClient
