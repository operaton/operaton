...
@TestPropertySource(properties = {
  "operaton.bpm.webapp.session-cookie.sameSiteCookieValue=aCustomValue"
})
@DirtiesContext
class SameSiteCustomValueIT {
  ...
  void shouldSetSameSiteCookieCustomValue() {
    ...
    assertThat(sessionCookieValue).matches(httpClientExtension.getSessionCookieRegex("aCustomValue"));
  }
