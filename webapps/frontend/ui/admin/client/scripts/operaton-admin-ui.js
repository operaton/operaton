...
var $ = (window.jQuery = window.$ = require('jquery')),
  ...
  camCommonsUi = require('operaton-commons-ui/lib'),
  sdk = require('operaton-bpm-sdk-js/lib/angularjs/index'),
  angular = require('operaton-commons-ui/vendor/angular'),
  camCommon = require('../../../common/scripts/module'),
  lodash = require('operaton-commons-ui/vendor/lodash'),
  moment = require('operaton-commons-ui/vendor/moment');
...
export function exposePackages(requirePackages) {
  ...
  requirePackages['operaton-commons-ui'] = camCommonsUi;
  requirePackages['operaton-bpm-sdk-js'] = sdk;
