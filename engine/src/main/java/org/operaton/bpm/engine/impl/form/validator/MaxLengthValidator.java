...
public class MaxLengthValidator extends AbstractTextValueValidator {
  ...
  protected boolean validate(String submittedValue, String configuration) {
    ...
    try {
      ...
      throw new FormFieldConfigurationException(configuration, "Cannot validate \"maxlength\": configuration %s cannot be interpreted as Integer".formatted(configuration));
    }
