...
class CollectMinHitPolicyHandlerTest extends SortingHitPolicyHandlerTest {

  private static final Double DOUBLE_MIN = -Double.MAX_VALUE;

  private static final String COLLECT_MIN_SINGLE =
      "org/operaton/bpm/dmn/engine/impl/hitpolicy/CollectMinHitPolicyHandlerTest.collect.min.single.dmn";
  private static final String COLLECT_MIN_COMPOUND =
      "org/operaton/bpm/dmn/engine/impl/hitpolicy/CollectMinHitPolicyHandlerTest.collect.min.compound.dmn";
