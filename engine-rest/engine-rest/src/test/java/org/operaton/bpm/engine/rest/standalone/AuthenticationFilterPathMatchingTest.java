...
public class AuthenticationFilterPathMatchingTest extends AbstractRestServiceTest {
  ...
  public static Collection<Object[]> getRequestUrls() {
    return List.of(new Object[][]{
        ...
        {"", "/engine", null, false},
        {"", "/engine/", null, false},
        {"", "/engine/default/setup/status", "default", false},
        {"", "/engine/default/setup/user/create", "default", false},
        {"", "/engine/default/identity/verify", "default", false},
        {"", "/engine/default/identity/password-policy", "default", false},
        {"", "/setup/status", "default", false},
        {"", "/setup/user/create", "default", false},
        {"", "/identity/verify", "default", false},
        {"", "/identity/password-policy", "default", false},
        {"", "/", "default", true},
        {"", "", "default", true},
