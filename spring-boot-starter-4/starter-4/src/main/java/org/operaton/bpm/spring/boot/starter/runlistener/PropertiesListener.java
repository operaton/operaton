...
public class PropertiesListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
  ...
  private final OperatonBpmVersion version;

  /**
   * Default constructor, used when initializing via spring.factories.
   *
   * @see PropertiesListener#PropertiesListener(OperatonBpmVersion)
   */
  public PropertiesListener() {
    this(new OperatonBpmVersion());
  }

  /**
   * Initialize with version.
   *
   * @param version the current operatonBpmVersion instance.
   */
  PropertiesListener(OperatonBpmVersion version) {
