...
package org.operaton.bpm.qa.upgrade.httl;
...
public class EnforceHistoryTimeToLiveScenario {
  ...
  public static String decisionWithoutHTTL() {
    return "org/operaton/bpm/qa/upgrade/httl/decision_without_httl.dmn";
  }

  @Deployment
  public static String caseWithoutHTTL() {
    return "org/operaton/bpm/qa/upgrade/httl/case_without_httl.cmmn";
  }
}
