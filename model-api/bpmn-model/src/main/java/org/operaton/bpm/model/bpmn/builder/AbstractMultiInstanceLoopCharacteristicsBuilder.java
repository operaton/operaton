...
public class AbstractMultiInstanceLoopCharacteristicsBuilder<B extends AbstractMultiInstanceLoopCharacteristicsBuilder<B>>
  ...
  /**
   * Sets the operaton collection expression.
   *
   * @param expression the collection expression
   * @return the builder object
   */
  public B operatonCollection(String expression) {
    element.setOperatonCollection(expression);

    return myself;
  }

  /**
   * Sets the operaton element variable name.
   *
   * @param variableName the name of the element variable
   * @return the builder object
   */
  public B operatonElementVariable(String variableName) {
    element.setOperatonElementVariable(variableName);
