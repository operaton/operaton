 ...
 *
 */
public final class NestedNonInterruptingBoundaryEventOnInnerSubprocessScenario {
  ...
  public static String deployMessageBoundary() {
    return "org/operaton/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }
