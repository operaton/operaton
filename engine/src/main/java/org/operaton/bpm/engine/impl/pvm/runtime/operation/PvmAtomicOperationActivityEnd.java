  ...
  public void execute(PvmExecutionImpl execution) {
    ...
    if(flowScope == activity.getProcessDefinition()) {
      ...
      if (activityBehavior instanceof CompositeActivityBehavior compositeActivityBehavior) {
        ...
        throw new ProcessEngineException("Expected behavior of composite scope %s to be a CompositeActivityBehavior but got %s".formatted(activity, activityBehavior));
      }
    }
  }
