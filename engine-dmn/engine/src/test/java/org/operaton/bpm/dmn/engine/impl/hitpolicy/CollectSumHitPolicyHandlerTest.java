...
class CollectSumHitPolicyHandlerTest extends SortingHitPolicyHandlerTest {

  private static final Double DOUBLE_MIN = -Double.MAX_VALUE;

  private static final String COLLECT_SUM_SINGLE =
      "org/operaton/bpm/dmn/engine/impl/hitpolicy/CollectSumHitPolicyHandlerTest.collect.sum.single.dmn";
  private static final String COLLECT_SUM_COMPOUND =
      "org/operaton/bpm/dmn/engine/impl/hitpolicy/CollectSumHitPolicyHandlerTest.collect.sum.compound.dmn";
