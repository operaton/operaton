 ...
 */
package org.operaton.bpm.engine.test.cockroachdb;
...
import org.operaton.bpm.engine.test.concurrency.CompetingExternalTaskFetchingTest;
import org.operaton.bpm.engine.test.concurrency.CompetingJobAcquisitionTest;
import org.operaton.bpm.engine.test.concurrency.ConcurrencyTestHelper;
import org.operaton.bpm.engine.test.concurrency.ConcurrentJobExecutorTest;
...
public class CockroachDBRetriesTest extends ConcurrencyTestHelper {
   ...
   */
  @Test
  @Deployment(resources = "org/operaton/bpm/engine/test/concurrency/CompetingExternalTaskFetchingTest.testCompetingExternalTaskFetching.bpmn20.xml")
