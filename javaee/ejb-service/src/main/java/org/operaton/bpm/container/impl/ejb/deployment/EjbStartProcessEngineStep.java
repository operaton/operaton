...
import org.operaton.bpm.container.impl.ejb.plugin.EjbConnectProcessEnginePlugin;
...
public class EjbStartProcessEngineStep extends StartProcessEngineStep {
  ...
  protected static final String CONNECT_PROCESS_ENGINE_PLUGIN = "org.operaton.connect.plugin.impl.ConnectProcessEnginePlugin";
  ...
  protected void additionalConfiguration(ProcessEngineConfigurationImpl configuration) {
    ...
    telemetryRegistry.setOperatonIntegration(OperatonIntegration.CAMUNDA_EJB_SERVICE);
