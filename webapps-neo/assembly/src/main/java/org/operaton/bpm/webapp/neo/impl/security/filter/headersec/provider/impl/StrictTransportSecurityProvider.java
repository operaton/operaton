...
import static org.operaton.bpm.webapp.neo.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.DISABLED;
import static org.operaton.bpm.webapp.neo.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.INCLUDE_SUBDOMAINS_DISABLED;
import static org.operaton.bpm.webapp.neo.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.MAX_AGE;
import static org.operaton.bpm.webapp.neo.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.VALUE;
