...
public class OperatonBpmRunCorsProperty {

  public static final String PREFIX = OperatonBpmRunProperties.PREFIX + ".cors";
  ...
  public OperatonBpmRunCorsProperty() {
  ...
  public String toString() {
    return "OperatonBpmRunCorsProperty [" +
        "enabled=" + enabled +
