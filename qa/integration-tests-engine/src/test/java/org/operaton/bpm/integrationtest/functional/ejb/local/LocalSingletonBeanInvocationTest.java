...
@Disabled("""
  ...
  Application that injects a @Singleton EJB from a separate WAR and is
  referenced from a BPMN service task via ${localSingletonBeanClientDelegateBean}.
...
public class LocalSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/operaton/bpm/integrationtest/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml")
