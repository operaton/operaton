...
public class StartEventTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<AttributeAssumption> getAttributesAssumptions() {
    return List.of(
      ...
      new AttributeAssumption(OPERATON_NS, "formRef"),
      new AttributeAssumption(OPERATON_NS, "formRefBinding"),
      new AttributeAssumption(OPERATON_NS, "formRefVersion"),
      new AttributeAssumption(OPERATON_NS, "initiator")
    );
  }
}
