...
public class DeploymentQueryDto extends AbstractQueryDto<DeploymentQuery> {
  ...
  @OperatonQueryParam("source")
  public void setSource(String source) {
    this.source = source;
  }

  @OperatonQueryParam(value = "withoutSource", converter = BooleanConverter.class)
  public void setWithoutSource(Boolean withoutSource) {
    this.withoutSource = withoutSource;
  }

  @OperatonQueryParam(value = "before", converter = DateConverter.class)
  public void setDeploymentBefore(Date deploymentBefore) {
    this.before = deploymentBefore;
  }

  @OperatonQueryParam(value = "after", converter = DateConverter.class)
  ...
  @OperatonQueryParam(value = "includeDeploymentsWithoutTenantId", converter = BooleanConverter.class)
