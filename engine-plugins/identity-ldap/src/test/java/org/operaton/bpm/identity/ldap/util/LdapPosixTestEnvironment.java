...
public class LdapPosixTestEnvironment extends LdapTestEnvironment {
  ...
  public void init() throws Exception {
    ...
    createUserUid("daniel", "office-berlin", "Daniel", "Meyer", "daniel@operaton.org");

    createGroup("people");
    createUserUid("ruecker", "people", "Bernd", "Ruecker", "ruecker@operaton.org");
    createUserUid("monster", "people", "Cookie", "Monster", "monster@operaton.org");
    createUserUid("fozzie", "people", "Bear", "Fozzie", "fozzie@operaton.org");
  ...
  protected void createPosixGroup(String gid, String name, String... memberUids) throws Exception {
    Dn dn = new Dn("cn=" + name + ",ou=groups,o=operaton,c=org");
