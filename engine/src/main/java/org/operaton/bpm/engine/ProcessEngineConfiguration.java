...
public abstract class ProcessEngineConfiguration {
  ...
  protected boolean jobExecutorAcquireWithSkipLocked = false;
   ...
   *
   * <p>By default only alphanumeric values (or 'operaton-admin') will be accepted.</p>
   */
  protected String generalResourceWhitelistPattern =  "[a-zA-Z0-9]+|operaton-admin";
   ...
   * values (or 'operaton-admin') will be accepted.</p>
   */
