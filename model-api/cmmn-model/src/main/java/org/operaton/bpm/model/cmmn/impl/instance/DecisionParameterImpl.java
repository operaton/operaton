...
import static org.operaton.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ELEMENT_DECISION_PARAMETER;

import org.operaton.bpm.model.cmmn.instance.DecisionParameter;
...
public class DecisionParameterImpl extends ParameterImpl implements DecisionParameter {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(DecisionParameter.class, CMMN_ELEMENT_DECISION_PARAMETER)
        ...
        .instanceProvider(instanceContext -> new DecisionParameterImpl(instanceContext));
