...
public class SLSBDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  void testBeanResolution() {
    ...
    assertEquals(true, runtimeService.getVariable(pi.getId(), SLSBDelegate.class.getName()));
  ...
  void testMultipleInvocations() {
    ...
    for(int i=0; i<instances; i++) {
      ...
      assertEquals(true, runtimeService.getVariable(ids[i], SLSBDelegate.class.getName()), "Incovation=" + i);
