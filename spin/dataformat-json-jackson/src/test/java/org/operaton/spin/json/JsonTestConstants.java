...
import org.operaton.spin.json.mapping.Invoice;
...
public class JsonTestConstants {
   ...
   */
  public static final String EXAMPLE_JACKSON_READ_CONFIGURATION_JSON_FILE_NAME = "org/operaton/spin/json/example_jackson.json";
  ...
  public static final String EXAMPLE_JACKSON_TYPE_JSON_FILE_NAME = "org/operaton/spin/json/example_jackson_types.json";
  ...
  public static void assertIsExampleOrder(Order order) {
    ...
    assertThat(orderDetails.getArticle()).isEqualTo("operatonBPM");
