 ...
 */
function OperatonForm(options) {
  if (!options) {
    throw new Error('OperatonForm need to be initialized with options.');
  }
...
OperatonForm.VariableManager = VariableManager;
OperatonForm.fields = {};
OperatonForm.fields.InputFieldHandler = InputFieldHandler;
OperatonForm.fields.ChoicesFieldHandler = ChoicesFieldHandler;
 ...
 * @type {Function}
 */
OperatonForm.extend = BaseClass.extend;

module.exports = OperatonForm;
