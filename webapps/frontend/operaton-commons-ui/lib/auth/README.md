...
require.config({
  ...
  shim: {
    ...
    'operaton-commons-ui/util': ['angular'],
    'operaton-commons-ui/auth': ['operaton-commons-ui-util']
  },
...
The operaton-commons-ui module adds interception of 401 responses (unauthorized) to ensure that a server side session timeout is correctly handled.
