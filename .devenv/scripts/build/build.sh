...
case "$BUILD_PROFILE" in
  ...
  "normal")
    ...
    ;;
  "max")
    PROFILES+=(distro distro-run distro-tomcat distro-wildfly distro-webjar distro-webjar-neo distro-starter h2-in-memory check-api-compatibility quarkus-tests)
    ;;
esac
