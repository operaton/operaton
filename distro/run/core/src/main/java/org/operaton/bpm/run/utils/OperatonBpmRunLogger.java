...
public class OperatonBpmRunLogger extends BaseLogger {

  public static final String PROJECT_CODE = "RUN";
  public static final String PROJECT_ID = "CR";
  public static final String PACKAGE = "org.operaton.bpm.run";

  public static final OperatonBpmRunLogger LOG = createLogger(OperatonBpmRunLogger.class, PROJECT_CODE, PACKAGE, PROJECT_ID);

  public void processEnginePluginRegistered(String pluginClass) {
      logInfo("001",
              "The process engine plugin '{}' was registered with the " +
                  "Operaton Run process engine.",
              pluginClass);
  }
