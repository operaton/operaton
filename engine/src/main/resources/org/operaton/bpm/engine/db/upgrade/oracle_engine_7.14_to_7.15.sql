...
-- allow retrieving and deleting reliable task-worker metrics through the Java API
...
-- allow adding, editing, and deleting incident annotations through the Java API
