...
class VariableInstanceTest {
  ...
  void shouldNotDeleteByteArrayWhenTypeDoesNotChange() {
        ...
        deployProcess(Bpmn.createExecutableProcess("testProcess")
                ...
                .scriptTask()
                .scriptFormat("groovy")
                .scriptText("execution.setVariable('myVar', new org.operaton.bpm.engine.test.bpmn.scripttask.MySerializable('updated value'))")
                .userTask()
                .endEvent()
                .done());
        ...
        assertThat(variable.getTextValue2())
                ...
                .isEqualTo("org.operaton.bpm.engine.test.bpmn.scripttask.MySerializable");
  ...
  void shouldDeleteByteArrayOnUpdateOfExistingNullVariable() {
        ...
        deployProcess(Bpmn.createExecutableProcess("testProcess")
                ...
                .scriptText("execution.setVariable('myVar', new org.operaton.bpm.engine.test.bpmn.scripttask.MySerializable('non null value'))")
                .userTask()
                .endEvent()
                .done());
