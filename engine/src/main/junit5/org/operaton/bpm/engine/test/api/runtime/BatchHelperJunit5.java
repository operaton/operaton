...
/**
 * Replacement for BatchHelper to ease migration from JUnit4 to JUnit5.
 */
public class BatchHelperJunit5 {

  private final ProcessEngineProvider processEngineProvider;

  public BatchHelperJunit5(ProcessEngineProvider processEngineProvider) {
