...
public interface ManagementService {
  ...
  /**
   * Enable/disable sending telemetry data to Operaton
   *
   * @throws AuthorizationException
   *          If the user is not a member of the group {@link Groups#CAMUNDA_ADMIN}.
   */
  ...
  /**
   * Checks how sending telemetry data to Operaton is configured
   * @return
   *   <ul>
   ...
   * If telemetry is enabled this information is sent to Operaton. If telemetry
