...
public class HistoricJobLogQueryDto extends AbstractQueryDto<HistoricJobLogQuery> {
  ...
  @OperatonQueryParam("jobExceptionMessage")
  ...
  @OperatonQueryParam(value="failedActivityIdIn", converter = StringArrayConverter.class)
  ...
  @OperatonQueryParam(value="jobPriorityHigherThanOrEquals", converter = LongConverter.class)
  ...
  @OperatonQueryParam(value="jobPriorityLowerThanOrEquals", converter = LongConverter.class)
