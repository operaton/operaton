...
class PriorityHitPolicyHandlerTest extends SortingHitPolicyHandlerTest {

  private static final String DMN_THREE_OUTPUTS_COMPOUND = "org/operaton/bpm/dmn/engine/impl/hitpolicy/PriorityHitPolicyHandlerTest.test_threeOutputsCompound_shouldSortOverAllOutputs.dmn";
  private static final String DMN_COMPOUND_OUTPUTS_ALL_OUTPUT_NAMES_SET = "org/operaton/bpm/dmn/engine/impl/hitpolicy/PriorityHitPolicyHandlerTest.test_compoundOutputs_shouldHaveAllOutputValuesSet.dmn";
  private static final String DMN_COMPOUND_OUTPUTS_PARTIAL_OUTPUT_VALUES = "org/operaton/bpm/dmn/engine/impl/hitpolicy/PriorityHitPolicyHandlerTest.test_compoundOutputs_shouldHavePartialOutputValuesSet.dmn";
  private static final String DMN_COMPOUND_OUTPUTS_NO_OUTPUT_VALUES = "org/operaton/bpm/dmn/engine/impl/hitpolicy/PriorityHitPolicyHandlerTest.test_compoundOutputs_shouldHaveNoOutputValuesSet.dmn";
  private static final String DMN_SINGLE_UNNAMED_OUTPUT = "org/operaton/bpm/dmn/engine/impl/hitpolicy/PriorityHitPolicyHandlerTest.test_singleUnnamedOutput.dmn";
  ...
  void test_singleUnnamedOutput(int input, String expectedResult) {
  ...
  public static Stream<Arguments> generateNoOutputValuesData() {
    return Stream.of(Arguments.of(Map.of("RiskCategory", "Medium", "IsExistingCustomer", false, "CustomerScore", 620),
      DmnHitPolicyException.class, "Priority hit policy requires at least one output value in the decision table outputs"));
  }
}
