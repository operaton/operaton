...
public interface DecisionTask extends Task {
  ...
  String getOperatonDecisionBinding();

  void setOperatonDecisionBinding(String operatonDecisionBinding);

  String getOperatonDecisionVersion();

  void setOperatonDecisionVersion(String operatonDecisionVersion);

  String getOperatonDecisionTenantId();

  void setOperatonDecisionTenantId(String operatonDecisionTenantId);
