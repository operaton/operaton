...
public abstract class MockProvider {
  ...
  public static final String EXAMPLE_DEPLOYMENT_CAMFORM_RESOURCE_ID = "aDeploymentOperatonFormResourceId";
  public static final String EXAMPLE_DEPLOYMENT_CAMFORM_RESOURCE_NAME = "a-operaton-form-resource.form";
  ...
  public static final String EXAMPLE_PROCESS_APPLICATION_CONTEXT_PATH = "http://operaton.org/someContext";
  ...
  public static TaskFormData createMockTaskFormDataUsingFormRef() {
    ...
    OperatonFormRefImpl formRef = new OperatonFormRefImpl(EXAMPLE_FORM_KEY, EXAMPLE_FORM_REF_BINDING);
    formRef.setVersion(EXAMPLE_FORM_REF_VERSION);
    when(mockFormData.getOperatonFormRef()).thenReturn(formRef);
  ...
  public static Resource createMockDeploymentOperatonFormResource() {
    Resource mockResource = mock(ResourceEntity.class);
