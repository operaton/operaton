 ...
 * See {@link NonPaContextCacheTestCase} for a detailed explanation.
 *
...
class NonPaContextCacheTest4 extends AbstractContextCacheTest {
  ...
  void contextCaching() {
    assertThat(applicationContext.hashCode())
        ...
        .isNotEqualTo(contextMap.get("nonPaTest3"))
        .isEqualTo(contextMap.get("nonPaTest2"));
  }
