...
class SessionCookiePathEnforcementAutoConfigurationTest {
  ...
  @BeforeEach
  void setUp() {
    AutoConfigurations autoConfigurationsUnderTest = AutoConfigurations.of(
        OperatonBpmAutoConfiguration.class, OperatonBpmWebappAutoConfiguration.class);
    AutoConfigurations additionalAutoConfigurations = AutoConfigurations.of(
        DataSourceAutoConfiguration.class, DataSourceTransactionManagerAutoConfiguration.class);
    contextRunner = new WebApplicationContextRunner()
        .withConfiguration(autoConfigurationsUnderTest)
        .withConfiguration(additionalAutoConfigurations);
  }
  ...
  void sessionCookiePathEnforcement_enabled_should_register_filter_with_correct_params() {
    contextRunner.withPropertyValues(
      ...
      FilterRegistrationBean<?> filterBean =
          context.getBean("sessionCookiePathFilter", FilterRegistrationBean.class);

      assertThat(filterBean.getUrlPatterns()).contains("/my-app/*");
      assertThat(filterBean.getInitParameters())
          .containsEntry(SessionCookiePathFilter.PARAM_COOKIE_PATH, "/my-app")
          .containsEntry(SessionCookiePathFilter.PARAM_SESSION_COOKIE_NAME, "CUSTOM_ID");
    });
  }
