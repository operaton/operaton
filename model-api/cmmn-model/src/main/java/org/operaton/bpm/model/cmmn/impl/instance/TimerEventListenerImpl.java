...
import org.operaton.bpm.model.cmmn.instance.TimerEventListener;
import org.operaton.bpm.model.cmmn.instance.TimerExpression;
...
import static org.operaton.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ELEMENT_TIMER_EVENT_LISTENER;
...
public class TimerEventListenerImpl extends EventListenerImpl implements TimerEventListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(TimerEventListener.class, CMMN_ELEMENT_TIMER_EVENT_LISTENER)
        ...
        .instanceProvider(TimerEventListenerImpl::new);
