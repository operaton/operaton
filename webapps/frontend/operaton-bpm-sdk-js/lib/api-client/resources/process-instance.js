...
var ProcessInstance = AbstractClientResource.extend(
  ...
  /** @lends  CamSDK.client.resource.ProcessInstance */
  {
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-delete/
     *
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-delete-historic-query-based/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-set-job-retries
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-set-job-retries-historic-query-based
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-activate-suspend-in-batch/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-set-variables-async/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
     ...
     *
     * @see https://docs.operaton.org/manual/latest/reference/rest/process-instance/post-message-async/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
