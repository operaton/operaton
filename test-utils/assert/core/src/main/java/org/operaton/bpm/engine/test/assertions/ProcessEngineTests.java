 ...
 */
package org.operaton.bpm.engine.test.assertions;


import org.operaton.bpm.engine.test.assertions.bpmn.BpmnAwareTests;
import org.operaton.bpm.engine.test.assertions.cmmn.CmmnAwareTests;

/**
 * Convenience class to access all available Operaton related
