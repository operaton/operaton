...
public class DeploymentCacheCfgTest {
  ...
  @RegisterExtension
  protected static ProcessEngineExtension cacheFactoryEngineRule = ProcessEngineExtension.builder().configurator(configuration -> {
  ...
  @RegisterExtension
  protected ProcessEngineTestExtension testRule = new ProcessEngineTestExtension(cacheFactoryEngineRule);
