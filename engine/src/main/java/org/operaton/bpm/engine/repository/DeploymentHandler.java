 ...
 * through the
 * {@link org.operaton.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl#setDeploymentHandlerFactory(DeploymentHandlerFactory)}
 * method.</p>
 *
 * <p>See {@link org.operaton.bpm.engine.impl.repository.DefaultDeploymentHandler} for the default
...
public interface DeploymentHandler {
   ...
   * {@link org.operaton.bpm.engine.impl.repository.DefaultDeploymentHandler#shouldDeployResource(Resource, Resource)}.</p>
   *
   ...
   * {@link org.operaton.bpm.engine.impl.jobexecutor.JobExecutor} and registered with the newly
