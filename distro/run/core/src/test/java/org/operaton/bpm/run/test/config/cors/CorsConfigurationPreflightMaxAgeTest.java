...
@TestPropertySource(properties = {OperatonBpmRunCorsProperty.PREFIX + ".preflight-maxage=2600"})
class CorsConfigurationPreflightMaxAgeTest extends AbstractRestTest {

  @Test
  void shouldUseACustomPreflightAge() {
    // given
