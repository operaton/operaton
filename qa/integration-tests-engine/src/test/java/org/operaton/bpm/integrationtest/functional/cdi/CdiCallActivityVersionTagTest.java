...
public class CdiCallActivityVersionTagTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/operaton/bpm/integrationtest/functional/cdi/CdiCallActivityVersionTagTest.subProcess.bpmn20.xml")
      .addAsResource("org/operaton/bpm/integrationtest/functional/cdi/CdiCallActivityVersionTagTest.bpmn20.xml");
  }
