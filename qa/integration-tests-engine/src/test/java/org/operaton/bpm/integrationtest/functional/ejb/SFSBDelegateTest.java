...
public class SFSBDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/operaton/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolution.bpmn20.xml")
      .addAsResource("org/operaton/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolutionFromClient.bpmn20.xml");
  }
  ...
  void testBeanResolution() {
    ...
    assertEquals(true, runtimeService.getVariable(pi.getId(), SFSBDelegate.class.getName()));
  ...
  void testMultipleInvocations() {
    ...
    for(int i=0; i<instances; i++) {
      ...
      assertEquals(true, runtimeService.getVariable(ids[i], SFSBDelegate.class.getName()), "Incovation=" + i);
