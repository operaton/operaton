...
import static org.operaton.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ELEMENT_OUTPUT;

import org.operaton.bpm.model.cmmn.instance.OutputProcessParameter;
import org.operaton.bpm.model.cmmn.instance.ProcessParameter;
...
public class OutputProcessParameterImpl extends ProcessParameterImpl implements OutputProcessParameter {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(OutputProcessParameter.class, CMMN_ELEMENT_OUTPUT)
      ...
      .instanceProvider(instanceContext -> new OutputProcessParameterImpl(instanceContext));
