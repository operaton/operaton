<#-- Generated From File: operaton-docs-manual/public/reference/rest/history/external-task-log/post-external-task-log-query/index.html -->
<#macro endpoint_macro docsUrl="">
{
  <@lib.endpointInfo
      id = "queryHistoricExternalTaskLogs"
      tag = "Historic External Task Log"
      summary = "List Historic External Task Logs"
