 ...
 */
package org.operaton.bpm.webapp.neo.impl;
...
public class WebappLogger extends BaseLogger {
  ...
  /** Distinct from the legacy webapp's "WEBAPP" so the two do not emit colliding message codes. */
  public static final String PROJECT_CODE = "WEBAPP-NEO";

  public static final WebappLogger INSTANCE = BaseLogger.createLogger(WebappLogger.class, PROJECT_CODE,
      "org.operaton.bpm.webapp.neo", "00");
