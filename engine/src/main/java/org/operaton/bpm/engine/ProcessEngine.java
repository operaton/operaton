 ...
 * {@link org.operaton.bpm.engine.repository.Deployment}s and the starting of and searching on
 * {@link org.operaton.bpm.engine.runtime.ProcessInstance}s.</li>
 * <li>
 * <b>{@link org.operaton.bpm.engine.TaskService}: </b> Exposes operations to manage human
 * (standalone) {@link org.operaton.bpm.engine.task.Task}s, such as claiming, completing and
 * assigning tasks</li>
 * <li>
 * <b>{@link org.operaton.bpm.engine.IdentityService}: </b> Used for managing
 * {@link org.operaton.bpm.engine.identity.User}s, {@link org.operaton.bpm.engine.identity.Group}s and
 * the relations between them<</li>
 * <li>
 * <b>{@link org.operaton.bpm.engine.ManagementService}: </b> Exposes engine admin and
