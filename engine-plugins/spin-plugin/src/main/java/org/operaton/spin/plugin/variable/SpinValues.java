...
import org.operaton.spin.plugin.variable.value.impl.builder.JsonValueBuilderImpl;
import org.operaton.spin.plugin.variable.value.impl.builder.XmlValueBuilderImpl;
