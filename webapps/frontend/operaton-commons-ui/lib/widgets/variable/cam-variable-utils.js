...
var angular = require('operaton-bpm-sdk-js/vendor/angular'),
  typeUtils = require('operaton-bpm-sdk-js/lib/forms/type-util'),
  templateDialog = require('./cam-widget-variable-dialog.html?raw'),
  templateStringDialog = require('./cam-widget-string-dialog.html?raw');

var varUtils = {};

function operatonFormattedDate(date) {
  date = date || new Date();
  return date.toISOString().slice(0, -5);
}
varUtils.operatonFormattedDate = operatonFormattedDate;
