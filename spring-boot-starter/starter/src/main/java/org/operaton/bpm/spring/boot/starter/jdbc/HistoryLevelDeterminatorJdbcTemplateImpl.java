...
public class HistoryLevelDeterminatorJdbcTemplateImpl implements HistoryLevelDeterminator, InitializingBean {
  ...
  public static HistoryLevelDeterminator createHistoryLevelDeterminator(OperatonBpmProperties operatonBpmProperties, JdbcTemplate jdbcTemplate) {
  ...
  public OperatonBpmProperties getOperatonBpmProperties() {
    return operatonBpmProperties;
  }

  public void setOperatonBpmProperties(OperatonBpmProperties operatonBpmProperties) {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Assert.notNull(operatonBpmProperties, "Operaton properties must be set");
    String historyLevelDefault = operatonBpmProperties.getHistoryLevelDefault();
  ...
  protected String getSql() {
    String tablePrefix = operatonBpmProperties.getDatabase().getTablePrefix();
    if (tablePrefix == null) {
      tablePrefix = "";
    }
