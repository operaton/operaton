...
public class ElResolverLookupTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource(
          "org/operaton/bpm/integrationtest/functional/el/services/org.operaton.bpm.application.ProcessApplicationElResolver",
          "META-INF/services/org.operaton.bpm.application.ProcessApplicationElResolver")
      .addAsResource("org/operaton/bpm/integrationtest/functional/el/elServiceTaskProcess.bpmn20.xml");
  }
