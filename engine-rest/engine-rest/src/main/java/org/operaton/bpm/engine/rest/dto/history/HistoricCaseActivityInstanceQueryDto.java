...
public class HistoricCaseActivityInstanceQueryDto extends AbstractQueryDto<HistoricCaseActivityInstanceQuery> {
  ...
  @OperatonQueryParam("caseActivityInstanceId")
  public void setCaseActivityInstanceId(String caseActivityInstanceId) {
    this.caseActivityInstanceId = caseActivityInstanceId;
  }

  @OperatonQueryParam(value = "caseActivityInstanceIdIn", converter = StringListConverter.class)
  ...
  @OperatonQueryParam("caseActivityId")
  ...
  @OperatonQueryParam(value = "endedBefore", converter = DateConverter.class)
  public void setEndedBefore(Date endedBefore) {
    this.endedBefore = endedBefore;
  }

  @OperatonQueryParam(value = "endedAfter", converter = DateConverter.class)
  ...
  @OperatonQueryParam(value = "available", converter = BooleanConverter.class)
