 ...
 * application module (deployment unit) to the process engine module (and other operaton libraries
...
public class ModuleDependencyProcessor implements DeploymentUnitProcessor {
  ...
  public static ModuleIdentifier MODULE_IDENTIFYER_PROCESS_ENGINE = ModuleIdentifier.create("org.operaton.bpm.operaton-engine");
  public static ModuleIdentifier MODULE_IDENTIFYER_XML_MODEL = ModuleIdentifier.create("org.operaton.bpm.model.operaton-xml-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_BPMN_MODEL = ModuleIdentifier.create("org.operaton.bpm.model.operaton-bpmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_CMMN_MODEL = ModuleIdentifier.create("org.operaton.bpm.model.operaton-cmmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_DMN_MODEL = ModuleIdentifier.create("org.operaton.bpm.model.operaton-dmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_SPIN = ModuleIdentifier.create("org.operaton.spin.operaton-spin-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_CONNECT = ModuleIdentifier.create("org.operaton.connect.operaton-connect-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_ENGINE_DMN = ModuleIdentifier.create("org.operaton.bpm.dmn.operaton-engine-dmn");
  public static ModuleIdentifier MODULE_IDENTIFYER_GRAAL_JS = ModuleIdentifier.create("org.graalvm.js.js-scriptengine");
  public static ModuleIdentifier MODULE_IDENTIFYER_JUEL = ModuleIdentifier.create("org.operaton.bpm.juel.operaton-juel");
