 ...
 */
package org.operaton.bpm.integrationtest.functional.telemetry;
...
public class TelemetryConnectPluginTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    final WebArchive webArchive =
        initWebArchiveDeployment("paConnectPlugin.war", "org/operaton/bpm/integrationtest/telemetry/processes-connectPlugin.xml")
