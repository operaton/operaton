...
This is a distribution of {{version}} (visit https://docs.operaton.org/) a Java-based framework. 
...
The Libraries used within Operaton {{versions}} are published under the following licenses:
