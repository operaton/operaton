...
public final class AsyncParallelMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeSubprocessProcess() {
    return "org/operaton/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTaskProcess() {
    return "org/operaton/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceTask.bpmn20.xml";
  }
