...
import org.operaton.bpm.container.impl.jboss.plugin.JBossConnectProcessEnginePlugin;
...
import org.operaton.bpm.container.impl.jboss.util.Tccl.Operation;
...
public class MscManagedProcessEngineController extends MscManagedProcessEngine {
  ...
  protected static final String CONNECT_PROCESS_ENGINE_PLUGIN_NAME = "org.operaton.connect.plugin.impl.ConnectProcessEnginePlugin";
  ...
  private Object createInstance(String configurationClassName) {
    try {
      ...
      throw new ProcessEngineException("Could not load '"+configurationClassName+"': the class must be visible from the operaton-wildfly-subsystem module.", e);
    }
  }
