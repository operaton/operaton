...
public class JuelExpression implements Expression {
  ...
  public Object getValue(VariableScope variableScope, BaseDelegateExecution contextExecution) {
    ...
    try {
      ...
      throw new ProcessEngineException("Unknown property used in expression: %s. Cause: ".formatted(expressionText)+pnfe.getMessage(), pnfe);
    } catch (MethodNotFoundException mnfe) {
      throw new ProcessEngineException("Unknown method used in expression: %s. Cause: ".formatted(expressionText)+mnfe.getMessage(), mnfe);
      ...
      if (cause != null) {
        ...
        throw new ProcessEngineException("Error while evaluating expression: %s. Cause: ".formatted(expressionText) + ele.getMessage(), ele);

      }
    } catch (Exception e) {
      throw new ProcessEngineException("Error while evaluating expression: %s. Cause: ".formatted(expressionText)+e.getMessage(), e);
    }
  }
