 ...
 * about the license key issued for enterprise versions of Operaton.
 *
...
public interface LicenseKeyData {
  ...
  /**
   * Operaton uses different license types e.g., when one license includes usage
   ...
   * could be Operaton BPM, Optimize or Cawemo.
   */
