...
@TestPropertySource(properties = {
  "operaton.bpm.webapp.session-cookie.enableSecureCookie=true"
})
@DirtiesContext
class SecureEnabledIT {
  ...
  void shouldEnableSecureCookie() {
    ...
    assertThat(sessionCookieValue).matches(httpClientExtension.getSessionCookieRegex("Lax", true));
  }
