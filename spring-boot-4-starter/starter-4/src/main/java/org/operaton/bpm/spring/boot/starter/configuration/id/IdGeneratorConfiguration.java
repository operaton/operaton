...
public class IdGeneratorConfiguration {
  ...
  @ConditionalOnProperty(prefix = OperatonBpmProperties.PREFIX, name = PROPERTY_NAME, havingValue = STRONG, matchIfMissing = true)
  ...
  @Bean
  @ConditionalOnMissingBean(IdGenerator.class)
  @ConditionalOnProperty(prefix = OperatonBpmProperties.PREFIX, name = PROPERTY_NAME, havingValue = PREFIXED)
