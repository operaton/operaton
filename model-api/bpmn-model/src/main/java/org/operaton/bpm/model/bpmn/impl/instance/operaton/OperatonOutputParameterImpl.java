...
import static org.operaton.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_OUTPUT_PARAMETER;
...
/**
 * The BPMN outputParameter operaton extension element
 *
...
public class OperatonOutputParameterImpl extends OperatonGenericValueElementImpl implements OperatonOutputParameter {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(OperatonOutputParameter.class, CAMUNDA_ELEMENT_OUTPUT_PARAMETER)
  ...
  public OperatonOutputParameterImpl(ModelTypeInstanceContext instanceContext) {
