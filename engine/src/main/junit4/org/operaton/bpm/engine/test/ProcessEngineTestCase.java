 ...
 * The processEngine will be initialized by default with the operaton.cfg.xml resource
...
public class ProcessEngineTestCase extends TestCase {
  ...
  @Deprecated(forRemoval = true, since = "1.0.0-beta-1") protected HistoryService historicDataService;
