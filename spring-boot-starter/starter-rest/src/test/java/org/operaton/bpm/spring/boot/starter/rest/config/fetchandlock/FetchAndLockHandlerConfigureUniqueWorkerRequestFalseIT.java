...
@TestPropertySource(properties = {"operaton.bpm.rest-api.fetch-and-lock.unique-worker-request=false"})
class FetchAndLockHandlerConfigureUniqueWorkerRequestFalseIT {

    @Autowired
    protected ServletContext servletContext;

    @Test
    void shouldReturnConfiguredUniqueWorkerRequest() {
        // when
