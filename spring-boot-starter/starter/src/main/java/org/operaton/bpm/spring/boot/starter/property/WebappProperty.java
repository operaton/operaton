...
public class WebappProperty {
  ...
  public static final String DEFAULT_APP_PATH = "/operaton";

  public static final String PREFIX = OperatonBpmProperties.PREFIX + ".webapp";

  protected boolean indexRedirectEnabled = true;

  protected String webjarClasspath = "/META-INF/resources/webjars/operaton";
