...
public class DmnDisabledTest {
  ...
  public void disabledDmn() {
    ...
    assertThat(processEngineImpl.getRepositoryService().createDecisionDefinitionQuery().list().size()).isEqualTo(0);
    assertThat(processEngineImpl.getRepositoryService().createDecisionRequirementsDefinitionQuery().count()).isEqualTo(0);
    assertThat(processEngineImpl.getRepositoryService().createDecisionRequirementsDefinitionQuery().list().size()).isEqualTo(0);
