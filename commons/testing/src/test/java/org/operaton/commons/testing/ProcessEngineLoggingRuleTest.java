...
public class ProcessEngineLoggingRuleTest {
  ...
  private static final String PERSISTENCE_LOGGER = "org.operaton.bpm.engine.persistence"; // 03
  private static final String CONTAINER_INTEGRATION_LOGGER = "org.operaton.bpm.container"; //08
