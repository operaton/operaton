...
public class AbstractConditionalEventDefinitionBuilder<B extends AbstractConditionalEventDefinitionBuilder<B>> extends AbstractRootElementBuilder<B, ConditionalEventDefinition> {
  ...
  /**
   * Sets the operaton variable name attribute, that defines on
   ...
   * @return the builder object
   */
  public B operatonVariableName(String variableName) {
    element.setOperatonVariableName(variableName);
    return myself;
  }

  /**
   * Set the operaton variable events attribute, that defines the variable
   ...
   * @return the builder object
   */
  public B operatonVariableEvents(String variableEvents) {
    element.setOperatonVariableEvents(variableEvents);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B operatonVariableEvents(List<String> variableEvents) {
    element.setOperatonVariableEventsList(variableEvents);
    return myself;
  }
