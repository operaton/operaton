            ...
            <table class="fade-in">
              ...
              <tbody>
                {tenants.value.data.map((tenant) => (
                  <tr key={tenant.id}>
                    <td>
                      <a href={`/admin/tenants/${encode_id(tenant.id)}`}>
                        {tenant.id}
                      </a>
                    </td>
                    <td>{tenant.name}</td>
  ...
  return (
    <div class="content fade-in">
      ...
      <ActionResult
        ...
        success={t("admin.tenant.success-created")}
      />
      <form onSubmit={on_submit}>
        ...
        <input
          id="tenant-name"
          type="text"
          onInput={(e) => set_value("name", e)}
          required
        />

        <div class="button-group">
          <button type="submit">{t("admin.tenant.create")}</button>
          <a class="button secondary" href="/admin/tenants">
            {t("common.cancel")}
          </a>
        </div>
      </form>
...
const TenantDetails = ({ tenant_id }) => {
  ...
  const set_value = (k, e) =>
    ...
    on_delete = () =>
      void engine_rest.tenant
        .delete(state, tenant_id)
        .then(() => route("/admin/tenants"));
  ...
  return (
    <div class="content fade-in">
      ...
      <ActionResult
        signal={tenant.update}
        success={t("admin.tenant.success-updated")}
      />
      {form.value ? (
        <form onSubmit={on_submit}>
          <label for="tenant-id">{t("admin.tenant.tenant-id")}</label>
      ...
      <MemberSection
        ...
        on_add={(member_id) =>
          engine_rest.tenant.add_user(state, tenant_id, member_id)
        }
        on_remove={(member_id) =>
          engine_rest.tenant.remove_user(state, tenant_id, member_id)
        }
      ...
      <MemberSection
        ...
        on_add={(member_id) =>
          engine_rest.tenant.add_group(state, tenant_id, member_id)
        }
        on_remove={(member_id) =>
          engine_rest.tenant.remove_group(state, tenant_id, member_id)
        }
      ...
      <div class="button-group">
        <button class="danger" onClick={() => (delete_open.value = true)}>
          {t("admin.tenant.delete")}
        </button>
      </div>
      <ConfirmDialog
        open={delete_open}
        message={t("admin.tenant.confirm-delete")}
...
const GroupsList = () => {
  ...
  const on_delete = () =>
    void engine_rest.group
      .delete(state, pending_delete.value)
      .then(() => engine_rest.group.all(state));
  ...
  return (
    <div class="content fade-in">
            ...
            <table class="fade-in">
              ...
              <tbody>
                {groups.value.data.map((group) => (
                  <tr key={group.id}>
                    <td>
                      <a href={`/admin/groups/${encode_id(group.id)}`}>
                        {group.id}
                      </a>
                    </td>
                    <td>{group.name}</td>
                    ...
                    <td>
                      <button
                        class="danger"
                        onClick={() => confirm_delete(group.id)}
                      >
                        {t("common.delete")}
                      </button>
                    </td>
      ...
      <ConfirmDialog
        open={delete_open}
        message={t("admin.group.confirm-delete")}
        on_confirm={on_delete}
      />
    </div>
  );
...
const GroupCreate = () => {
  ...
  return (
    <div class="content fade-in">
      ...
      <ActionResult
        signal={group_create}
        success={t("admin.group.success-created")}
      />
      <form onSubmit={on_submit}>
        ...
        <input
          id="group-type"
          type="text"
          onInput={(e) => set_value("type", e)}
        />

        <div class="button-group">
          <button type="submit">{t("admin.group.create")}</button>
          <a class="button secondary" href="/admin/groups">
            {t("common.cancel")}
          </a>
        </div>
      </form>
...
const GroupDetails = ({ group_id }) => {
  ...
  return (
    <div class="content fade-in">
      ...
      <ActionResult
        signal={group.update}
        success={t("admin.group.success-updated")}
      />
      {form.value ? (
        <form onSubmit={on_submit}>
          <label for="group-id">{t("admin.group.group-id")}</label>
      ...
      <MemberSection
        ...
        id_label={t("admin.user.user-id")}
        on_add={(member_id) =>
          engine_rest.group.add_user(state, group_id, member_id)
        }
        on_remove={(member_id) =>
          engine_rest.group.remove_member(state, group_id, member_id)
        }
...
const MemberSection = ({
  ...
  const confirm_remove = (member_id) => {
    ...
    do_remove = () =>
      void Promise.resolve(on_remove(pending_remove.value)).then(refetch),
    do_add = (e) => {
      e.preventDefault();
  ...
  return (
    <>
      ...
      <RequestState
        signal={list_signal}
        on_success={() =>
          list_signal.value.data.length !== 0 ? (
            <table>
              <thead>
                <tr>
                  <th>{t("common.id")}</th>
                ...
                {list_signal.value.data.map((member) => (
                  <tr key={member.id}>
                    ...
                    <td>
                      <button
                        class="danger"
                        onClick={() => confirm_remove(member.id)}
                      >
                        {t("common.remove")}
                      </button>
                    </td>
      ...
      <ConfirmDialog
        ...
        message={t("admin.confirm-remove-member")}
      ...
      <table class="fade-in">
        ...
        <tbody>
          <RequestState
            signal={users}
            on_success={() =>
              users.value?.data.map(({ id, firstName, lastName, email }) => (
                <tr key={id}>
                  <td>
                    <a href={`/admin/users/${encode_id(id)}`}>{id}</a>
                  </td>
                  <td>{firstName}</td>
                  <td>{lastName}</td>
                  <td>{email}</td>
...
const UserCreate = () => {
  ...
  const set_value = (k1, k2, e) =>
      (form.value = {
        ...form.peek(),
        [k1]: { ...form.peek()[k1], [k2]: e.currentTarget.value },
      }),
  ...
  return (
    <div class="content fade-in">
      ...
      <ActionResult
        signal={user_create}
        success={t("admin.user.success-created")}
      />
      <div aria-live="polite">
        {mismatch.value ? (
          <p class="error">{t("admin.user.password-mismatch")}</p>
        ) : null}
      </div>
      <form onSubmit={on_submit}>
...
const UserDetails = ({ user_id }) => {
  ...
  return (
    <div class="content fade-in">
      ...
      <ConfirmDialog
        open={delete_open}
        message={t("admin.user.confirm-delete")}
        on_confirm={on_delete}
      />
    </div>
  );
    ...
    <>
      ...
      <form onSubmit={on_submit}>
        ...
        <input
          ...
          onInput={(e) => set_value("firstName", e)}
        />
        ...
        <input
          ...
          onInput={(e) => set_value("lastName", e)}
        />
...
const UserPassword = ({ user_id }) => {
  ...
  return (
    <>
      ...
      <ActionResult
        signal={credentials}
        success={t("admin.user.password-success")}
      />
      <div aria-live="polite">
        {mismatch.value ? (
          <p class="error">{t("admin.user.password-mismatch")}</p>
      ...
      <form onSubmit={on_submit}>
        ...
        <label for="new-password-repeat">
          {t("admin.user.new-password-repeat")}
        </label>
        <input
...
const UserGroups = ({ user_id }) => {
  ...
  const refetch = () => engine_rest.group.by_member(state, user_id),
    ...
    do_remove = () =>
      void engine_rest.group
        .remove_member(state, pending_remove.value, user_id)
        .then(refetch),
    do_add = (e) => {
      e.preventDefault();
      void engine_rest.group
        .add_user(state, new_group.value, user_id)
        .then(() => {
          new_group.value = "";
          add_open.value = false;
          refetch();
  ...
  return (
    <>
      ...
      <RequestState
        signal={user_groups}
        on_success={() =>
          user_groups.value.data.length !== 0 ? (
            <table>
              <caption class="screen-hidden">
                {t("admin.group.user-groups")}
              </caption>
              <thead>
                <tr>
                  <th>{t("common.id")}</th>
                ...
                {user_groups.value.data.map((group) => (
                  <tr key={group.id}>
                    ...
                    <td>
                      <button
                        class="danger"
                        onClick={() => confirm_remove(group.id)}
                      >
                        {t("admin.user.remove-from-group")}
                      </button>
                    </td>
                  </tr>
                ))}
      ...
      <div class="button-group">
        <button onClick={() => (add_open.value = true)}>
          {t("admin.user.add-to-group")}
        </button>
      </div>
      ...
      <ConfirmDialog
        open={remove_open}
        confirm_label={t("common.remove")}
        message={t("admin.user.confirm-remove-from-group")}
        on_confirm={do_remove}
      />
    </>
  );
...
const AuthorizationsPage = () => {
  const {
      params: { selection_id, sub_selection_id },
    } = useRoute(),
    resource_type =
      selection_id === "resource-type" ? sub_selection_id : undefined,
    state = useContext(AppState),
    [t] = useTranslation(),
  ...
  return (
    <div class="content fade-in">
      ...
      {!resource_type ? (
          ...
          <ul class="link-list">
            {authorization_resources.map(({ nameKey, resource_type }) => (
              <li key={resource_type}>
                <a
                  href={`/admin/authorizations/resource-type/${resource_type}`}
                >
                  {t(nameKey)}
                </a>
              </li>
        ...
        <>
          <h2>
            {resource ? t(resource.nameKey) : ""}{" "}
            {t("admin.authorization.title")}
          </h2>
          {resource ? (
            <p>
              <small>
                {t("admin.authorization.resource-id")}: {resource.resource_id}
              </small>
            </p>
          ) : null}
          ...
          <table class="fade-in auth-table">
            ...
            <tbody>
              <RequestState
                ...
                on_success={() =>
                  state.api.authorization.all.value.data.map(
                    (authorization) => (
                      <AuthorizationResourceRow
...
const AuthorizationCreate = ({ resource, resource_type, on_done }) => {
  ...
  return (
    <form onSubmit={on_submit} class="authorization-create">
      <ActionResult
        signal={create}
      ...
      <label for="auth-resource-id">
        {t("admin.authorization.resource-id")}
      </label>
      <input
        id="auth-resource-id"
        type="text"
        value={form.value.resourceId}
      ...
      <div class="button-group">
        <button type="submit">{t("common.save")}</button>
        <button type="button" class="secondary" onClick={on_done}>
          {t("common.cancel")}
        </button>
      </div>
    </form>
...
const AuthorizationResourceRow = ({ authorization }) => {
  const {
    ...
    resource = authorization_resources.find(
      (r) => r.resource_type === authorization.resourceType,
    ),
    available_permissions = resource?.permissions ?? [];

  const type_label = {
      0: t("admin.authorization.global-display"),
      1: t("admin.authorization.allow-display"),
      2: t("admin.authorization.deny-display"),
    }[type],
    ...
    <tr>
      {!is_edit.value ? (
        <>
          ...
          <td>
            <div class="button-group">
              <button onClick={() => (is_edit.value = true)}>
                {t("common.edit")}
              </button>
              <button class="danger" onClick={() => (delete_open.value = true)}>
                {t("common.delete")}
              ...
              <ConfirmDialog
                open={delete_open}
                message={t("admin.authorization.confirm-delete")}
                on_confirm={on_delete}
              />
            </div>
          </td>
        ...
        <>
          ...
          <td>
            <input
              form={form_id}
              name="resourceId"
              aria-label={t("admin.authorization.resource-id")}
              value={form.value.resourceId}
              onInput={(e) => set_value("resourceId", e)}
              placeholder={resource?.resource_id}
          ...
          <td>
            <div class="button-group">
              <button onClick={on_cancel}>{t("common.cancel")}</button>
...
const authorization_resources = [
  {
    id: "application",
    nameKey: "admin.authorization-resources.application",
    resource_type: 0,
    resource_id: "admin/cockpit/tasklist/*",
    permissions: ["ALL", "ACCESS"],
  },
  {
    id: "authorization",
    nameKey: "admin.authorization-resources.authorization",
    resource_type: 4,
  ...
  {
    id: "batch",
    nameKey: "admin.authorization-resources.batch",
    resource_type: 13,
  ...
  },
  {
    ...
    nameKey: "admin.authorization-resources.decision-definition",
    resource_type: 10,
    resource_id: "Decision Definition Key",
    permissions: [
      "ALL",
      "READ",
      "UPDATE",
  ...
  {
    id: "decision_requirements_definition",
    nameKey: "admin.authorization-resources.decision-requirements-definition",
    resource_type: 14,
    resource_id: "Decision Requirements Definition Key",
    permissions: ["ALL", "READ"],
  },
  {
    id: "deployment",
    nameKey: "admin.authorization-resources.deployment",
    resource_type: 9,
    resource_id: "Deployment ID",
    permissions: ["ALL", "READ", "CREATE", "DELETE"],
  },
  {
    id: "filter",
    nameKey: "admin.authorization-resources.filter",
    resource_type: 5,
  ...
  {
    id: "group",
    nameKey: "admin.authorization-resources.group",
    resource_type: 2,
  ...
  {
    id: "group_membership",
    nameKey: "admin.authorization-resources.group-membership",
    resource_type: 3,
    resource_id: "Group ID",
    permissions: ["ALL", "CREATE", "DELETE"],
  },
  {
    id: "process_definition",
    nameKey: "admin.authorization-resources.process-definition",
    resource_type: 6,
    resource_id: "Process Definition Key",
    permissions: [
      "ALL",
      "READ",
      "UPDATE",
  ...
  {
    id: "process_instance",
    nameKey: "admin.authorization-resources.process-instance",
    resource_type: 8,
  ...
  {
    id: "task",
    nameKey: "admin.authorization-resources.task",
    resource_type: 7,
    resource_id: "Task ID",
    permissions: [
      "ALL",
  ...
  {
    id: "historic_task",
    nameKey: "admin.authorization-resources.historic-task",
    resource_type: 19,
    resource_id: "Historic Task ID",
    permissions: ["ALL", "READ", "READ_VARIABLE"],
  },
  {
    id: "historic_process_instance",
    nameKey: "admin.authorization-resources.historic-process-instance",
    resource_type: 20,
    resource_id: "Historic Process Instance ID",
    permissions: ["ALL", "READ"],
  },
  {
    id: "tenant",
    nameKey: "admin.authorization-resources.tenant",
    resource_type: 11,
  ...
  },
  {
    ...
    nameKey: "admin.authorization-resources.tenant-membership",
    resource_type: 12,
    resource_id: "Tenant ID",
    permissions: ["ALL", "CREATE", "DELETE"],
  },
  {
    id: "user",
    nameKey: "admin.authorization-resources.user",
    resource_type: 1,
    resource_id: "User ID",
    permissions: CRUD,
  },
  {
    id: "report",
    nameKey: "admin.authorization-resources.report",
    resource_type: 15,
  ...
  {
    id: "dashboard",
    nameKey: "admin.authorization-resources.dashboard",
    resource_type: 16,
    resource_id: "Dashboard",
    permissions: CRUD,
  },
  {
    id: "user_operation_log_category",
    nameKey: "admin.authorization-resources.user-operation-log",
    resource_type: 17,
    resource_id: "User Operation Log Category",
    permissions: ["ALL", "READ", "UPDATE", "DELETE"],
  },
  {
    id: "system",
    nameKey: "admin.authorization-resources.system",
    resource_type: 21,
    resource_id:
