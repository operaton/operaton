...
public class MinLengthValidator extends AbstractTextValueValidator {
  ...
  protected boolean validate(String submittedValue, String configuration) {
    ...
    try {
      ...
      throw new FormFieldConfigurationException(configuration, "Cannot validate \"minlength\": configuration %s cannot be interpreted as Integer".formatted(configuration));
    }
