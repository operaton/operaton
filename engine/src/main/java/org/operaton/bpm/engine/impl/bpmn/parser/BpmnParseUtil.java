...
import org.operaton.bpm.engine.impl.core.variable.mapping.value.ListValueProvider;
import org.operaton.bpm.engine.impl.core.variable.mapping.value.MapValueProvider;
...
public final class BpmnParseUtil {
  ...
  public static IoMapping parseInputOutput(Element element) {
    ...
    if(inputOutputElement != null) {
      ...
      parseOperatonInputParameters(inputOutputElement, ioMapping);
      parseOperatonOutputParameters(inputOutputElement, ioMapping);
      return ioMapping;
    }
    return null;
  }
   ...
   */
  public static void parseOperatonInputParameters(Element inputOutputElement, IoMapping ioMapping) {
    List<Element> inputParameters = inputOutputElement.elementsNS(BpmnParse.OPERATON_BPMN_EXTENSIONS_NS, "inputParameter");
   ...
   */
  public static void parseOperatonOutputParameters(Element inputOutputElement, IoMapping ioMapping) {
    List<Element> outputParameters = inputOutputElement.elementsNS(BpmnParse.OPERATON_BPMN_EXTENSIONS_NS, "outputParameter");
  ...
  /**
   * Parses a operaton script element.
   *
  ...
  public static Map<String, String> parseOperatonExtensionProperties(Element element){
    Element propertiesElement = findOperatonExtensionElement(element, "properties");
