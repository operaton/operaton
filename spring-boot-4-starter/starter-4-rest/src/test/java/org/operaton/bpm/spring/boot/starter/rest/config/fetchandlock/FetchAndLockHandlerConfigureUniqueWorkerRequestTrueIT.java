...
@TestPropertySource(properties = {"operaton.bpm.rest-api.fetch-and-lock.unique-worker-request=true"})
class FetchAndLockHandlerConfigureUniqueWorkerRequestTrueIT {
