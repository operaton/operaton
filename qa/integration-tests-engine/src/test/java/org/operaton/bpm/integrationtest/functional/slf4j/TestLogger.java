...
public class TestLogger extends BaseLogger {
  ...
  public static final TestLogger INSTANCE = BaseLogger.createLogger(TestLogger.class, "QA", "org.operaton.bpm.qa", "01");

  /**
   * Verify that operaton commons log a messages with a single format parameter.
  ...
  /**
   * Verify that operaton commons log a messages with two format parameters.
  ...
  /**
   * Verify that operaton commons log a messages which uses the array formatter (more than two format parameters).
