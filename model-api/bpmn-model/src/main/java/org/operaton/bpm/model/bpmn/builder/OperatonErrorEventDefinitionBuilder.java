...
public class OperatonErrorEventDefinitionBuilder extends AbstractErrorEventDefinitionBuilder<OperatonErrorEventDefinitionBuilder> {
  ...
  public OperatonErrorEventDefinitionBuilder(BpmnModelInstance modelInstance, ErrorEventDefinition element) {
    super(modelInstance, element, OperatonErrorEventDefinitionBuilder.class);
  }

  public OperatonErrorEventDefinitionBuilder expression(String expression) {
