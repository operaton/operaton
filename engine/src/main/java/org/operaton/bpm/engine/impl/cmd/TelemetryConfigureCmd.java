...
public class TelemetryConfigureCmd implements Command<Void> {
  ...
  protected static final String TELEMETRY_PROPERTY = "operaton.telemetry.enabled";
  ...
  public Void execute(CommandContext commandContext) {
    ...
    authorizationManager.checkOperatonAdminOrPermission(CommandChecker::checkConfigureTelemetry);
