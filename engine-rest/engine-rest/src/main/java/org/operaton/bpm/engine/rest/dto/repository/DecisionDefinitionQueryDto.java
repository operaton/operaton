...
public class DecisionDefinitionQueryDto extends AbstractQueryDto<DecisionDefinitionQuery> {
  ...
  @OperatonQueryParam(value = "decisionDefinitionIdIn", converter = StringListConverter.class)
  ...
  @OperatonQueryParam(value = "withoutDecisionRequirementsDefinition", converter = BooleanConverter.class)
  ...
  @OperatonQueryParam(value = "includeDecisionDefinitionsWithoutTenantId", converter = BooleanConverter.class)
